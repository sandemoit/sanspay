<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <p class="fw-bold">Catatan Penting:</p>
                    <ul>
                        <li>MLBB - ID + Server (Jika ada), Contoh: 12345678 (1234), Jadi = 123456781234</li>
                        <li>PUBGM - UID Contoh: 12345678</li>
                        <li>FF - Player ID Contoh: 12345678</li>
                        <li>PB - Username zepetto Contoh: Sanspay105</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    @push('custom-js')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function checkCategory(brand) {
                    ...
                    if (typeof $ !== 'undefined') {
                        $.ajax({
                            url: '{{ secure_url(route('priceGames')) }}',
                            type: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
        ...
        <script>
            function prepaid(url) {
                ...
                if (!phone) {
                    toastr.error('Nomor pelanggan tidak boleh kosong!', {
                        timeOut: 1000
                    });
                    return;
                }
